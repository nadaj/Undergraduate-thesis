        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="bs-component">
                    ...
                    <a href="{{ route('initiator.votinginfo', ['votings_id' => $voting->id]) }}" class="btn btn-primary btn-lg btn-block btn-raised">Više informacija</a>
                </div>
            </div>
        </div>
        @else
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="bs-component">
                    ...
                    <a href="{{ route('initiator.votinginfo', ['votings_id' => $voting->id]) }}" class="btn btn-default btn-lg btn-block btn-raised">Više informacija</a>
                </div>
            </div>
        </div>
        @endif
            ...
            <div class="panel-body">
                <div class="bs-component">
                  ...
                  <p><b>Kriterijum uspešnosti glasanja:</b>
                    @if ($past_successes[$j]->answer_id != null) 
